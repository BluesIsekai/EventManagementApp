  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center space-y-3">
        <h2 className="text-3xl font-bold text-gray-900">🙏 Ganesh Chaturthi Dashboard</h2>
        <p className="text-lg text-gray-600">Welcome to the event management system</p>
      </div>
        ...
        <div className="rounded-xl bg-white border border-gray-200 shadow-lg overflow-hidden">
          ...
          {recentPayments.length > 0 && (
            <div className="bg-gray-50 px-6 py-3 border-t">
              <Link to="/payments" className="text-sm text-blue-600 hover:text-blue-800 font-medium">
                View all payments →
              </Link>
            </div>
          )}
